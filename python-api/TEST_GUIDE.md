...
curl http://spring:9090/api/health
...
- **Spring Boot** : http://spring:9090
- **Documentation FastAPI** : http://spring:9090/docs
...
```bash
curl -X POST http://fastapi:8000/api/auth/login \
...
curl -X POST http://spring:9090/api/auth/verify \
  -H "Authorization: Bearer <TOKEN>"
```

### 1.3 Health Check
```bash
curl http://spring:9090/api/auth/health
```
...
```bash
curl http://spring:9090/api/v1/medecins \
  -H "Authorization: Bearer <TOKEN>"
```

### 2.2 Détail d'un médecin
```bash
<!--curl http://spring:9090/api/v1/medecins/1 \-->
<!--  -H "Authorization: Bearer <TOKEN>"-->
```

### 2.3 Créer un médecin avec compte utilisateur
```bash
curl -X POST http://spring:9090/api/v1/medecins/create-with-user \
  -H "Authorization: Bearer <TOKEN>" \
  -H "Content-Type: application/json" \
  -d '{
    "nom": "Martin",
...
```bash
curl http://spring:9090/api/v1/secretaires \
  -H "Authorization: Bearer <TOKEN>"
```

### 3.2 Créer une secrétaire
```bash
curl -X POST http://spring:9090/api/v1/secretaires/create \
  -H "Authorization: Bearer <TOKEN>" \
  -H "Content-Type: application/json" \
  -d '{
    "nom": "Dupont",
...
```bash
curl http://spring:9090/api/users/list \
  -H "Authorization: Bearer <TOKEN>"
```

### 4.2 Liste par rôle
```bash
curl "http://spring:9090/api/users/list?role=MEDECIN" \
  -H "Authorization: Bearer <TOKEN>"
```

### 4.3 Détail d'un utilisateur
```bash
curl http://spring:9090/api/users/admin \
  -H "Authorization: Bearer <TOKEN>"
```

### 4.4 Créer un utilisateur
```bash
curl -X POST http://spring:9090/api/users/create \
  -H "Authorization: Bearer <TOKEN>" \
  -H "Content-Type: application/json" \
  -d '{
    "username": "newuser",
...
```bash
curl "http://spring:9090/api/v1/patients?page=0&size=10" \
  -H "Authorization: Bearer <TOKEN>"
```

### 5.2 Recherche de patients
```bash
curl "http://spring:9090/api/v1/patients/search?keyword=dupont" \
  -H "Authorization: Bearer <TOKEN>"
```

### 5.3 Détail d'un patient
```bash
curl http://spring:9090/api/v1/patients/1 \
  -H "Authorization: Bearer <TOKEN>"
```

### 5.4 Créer un patient
```bash
curl -X POST http://spring:9090/api/v1/patients/save \
  -H "Authorization: Bearer <TOKEN>" \
  -H "Content-Type: application/json" \
  -d '{
    "nom": "Durand",
...
```bash
curl -X PUT http://spring:9090/api/v1/patients/update \
  -H "Authorization: Bearer <TOKEN>" \
  -H "Content-Type: application/json" \
  -d '{
    "id": 1,
...
```bash
curl -X DELETE http://spring:9090/api/v1/patients/1 \
  -H "Authorization: Bearer <TOKEN>"
```
...
```bash
curl http://spring:9090/api/v1/consultations \
  -H "Authorization: Bearer <TOKEN>"
```

### 6.2 Consultations par patient
```bash
curl http://spring:9090/api/v1/consultations/patient/1 \
  -H "Authorization: Bearer <TOKEN>"
```

### 6.3 Consultations par médecin
```bash
curl http://spring:9090/api/v1/consultations/medecin/1 \
  -H "Authorization: Bearer <TOKEN>"
```

### 6.4 Créer une consultation
```bash
curl -X POST http://spring:9090/api/v1/consultations/save \
  -H "Authorization: Bearer <TOKEN>" \
  -H "Content-Type: application/json" \
  -d '{
    "date": "2024-03-28",
...
```bash
curl http://spring:9090/api/v1/rendez-vous \
  -H "Authorization: Bearer <TOKEN>"
```

### 7.2 Rendez-vous filtrés
```bash
curl "http://spring:9090/api/v1/rendez-vous?date=2024-03-28&medecin_id=1" \
  -H "Authorization: Bearer <TOKEN>"
```

### 7.3 Créer un rendez-vous
```bash
curl -X POST http://spring:9090/api/v1/rendez-vous/save \
  -H "Authorization: Bearer <TOKEN>" \
  -H "Content-Type: application/json" \
  -d '{
    "date": "2024-03-28",
...
```bash
curl -X POST http://spring:9090/api/v1/rendez-vous/1/confirm \
  -H "Authorization: Bearer <TOKEN>"
```

### 7.5 Supprimer un rendez-vous
```bash
curl -X DELETE http://spring:9090/api/v1/rendez-vous/1 \
  -H "Authorization: Bearer <TOKEN>"
```

### 7.6 Calendrier (events)
```bash
curl "http://spring:9090/api/v1/rendez-vous/calendar/events?start_date=2024-03-01&end_date=2024-03-31" \
  -H "Authorization: Bearer <TOKEN>"
```
...
```bash
curl http://spring:9090/api/v1/ordonnances \
  -H "Authorization: Bearer <TOKEN>"
```

### 8.2 Ordonnances par patient
```bash
curl http://spring:9090/api/v1/ordonnances/patient/1 \
  -H "Authorization: Bearer <TOKEN>"
```

### 8.3 Créer une ordonnance
```bash
curl -X POST http://spring:9090/api/v1/ordonnances/save \
  -H "Authorization: Bearer <TOKEN>" \
  -H "Content-Type: application/json" \
  -d '{
    "patientId": 1,
...
### 8.4 Générer PDF
```bash
curl http://spring:9090/api/v1/ordonnances/1/pdf \
  -H "Authorization: Bearer <TOKEN>"
```

### 8.5 Envoyer par email
```bash
curl -X POST http://spring:9090/api/v1/ordonnances/1/send-email \
  -H "Authorization: Bearer <TOKEN>"
```
...
```bash
curl "http://spring:9090/api/v1/medicaments?page=0&size=10" \
  -H "Authorization: Bearer <TOKEN>"
```

### 9.2 Recherche de médicaments
```bash
curl "http://spring:9090/api/v1/medicaments/search?keyword=doliprane" \
  -H "Authorization: Bearer <TOKEN>"
```

### 9.3 Créer un médicament
```bash
curl -X POST http://spring:9090/api/v1/medicaments/save \
  -H "Authorization: Bearer <TOKEN>" \
  -H "Content-Type: application/json" \
  -d '{
    "nom": "Efferalgan",
...
```bash
curl http://spring:9090/api/v1/notifications \
  -H "Authorization: Bearer <TOKEN>"
```

### 10.2 Notifications non lues
```bash
curl http://spring:9090/api/v1/notifications/unread \
  -H "Authorization: Bearer <TOKEN>"
```

### 10.3 Compte des non lues
```bash
curl http://spring:9090/api/v1/notifications/count \
  -H "Authorization: Bearer <TOKEN>"
```

### 10.4 Marquer comme lue
```bash
curl -X POST http://spring:9090/api/v1/notifications/1/mark-read \
  -H "Authorization: Bearer <TOKEN>"
```
...
```bash
curl "http://spring:9090/api/v1/calendar/events?start_date=2024-03-01&end_date=2024-03-31" \
  -H "Authorization: Bearer <TOKEN>"
```

### 11.2 Disponibilités d'un médecin
```bash
curl "http://spring:9090/api/v1/calendar/disponibilites/1?date=2024-03-28" \
  -H "Authorization: Bearer <TOKEN>"
```

### 11.3 Statistiques
```bash
curl "http://spring:9090/api/v1/calendar/stats?start_date=2024-03-01&end_date=2024-03-31" \
  -H "Authorization: Bearer <TOKEN>"
```
...
```bash
# 1. Login
TOKEN=$(curl -s -X POST http://spring:9090/api/auth/login \
  -H "Content-Type: application/json" \
...
# 2. Créer un patient
PATIENT_ID=$(curl -s -X POST http://spring:9090/api/v1/patients/save \
  -H "Authorization: Bearer $TOKEN" \
  -H "Content-Type: application/json" \
...
CONSULT_ID=$(curl -s -X POST http://spring:9090/api/v1/consultations/save \
  -H "Authorization: Bearer $TOKEN" \
  -H "Content-Type: application/json" \
...
- **Swagger UI** : http://spring:9090/docs
- **ReDoc** : http://spring:9090/redoc
- **OpenAPI JSON** : http://spring:9090/openapi.json
...
```env
SPRING_BOOT_URL=http://spring:9090
